...
public class GraphY extends View {

    private int realWidth, realHeight;
    private final int xDensity = 200, yDensity = 200;
    ...
    public GraphY(Context context) {
        this(context, null);
    }

    public GraphY(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        realWidth = getWidth() - getPaddingRight() - getPaddingLeft();
